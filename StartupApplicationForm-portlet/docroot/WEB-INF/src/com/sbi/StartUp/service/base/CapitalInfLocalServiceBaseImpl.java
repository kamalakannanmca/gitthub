...
/**
 * The base implementation of the capital inf local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sbi.StartUp.service.impl.CapitalInfLocalServiceImpl}.
 * </p>
 *
 * @author MAH97223
 * @see com.sbi.StartUp.service.impl.CapitalInfLocalServiceImpl
 * @see com.sbi.StartUp.service.CapitalInfLocalServiceUtil
 * @generated
 */
public abstract class CapitalInfLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CapitalInfLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sbi.StartUp.service.CapitalInfLocalServiceUtil} to access the capital inf local service.
	 */
	...
	public CapitalInf addCapitalInf(CapitalInf capitalInf)
		throws SystemException {
		capitalInf.setNew(true);

		return capitalInfPersistence.update(capitalInf, false);
	}
	 ...
	 */
	public CapitalInf createCapitalInf(long InfRefId) {
		return capitalInfPersistence.create(InfRefId);
	}
	...
	public CapitalInf deleteCapitalInf(long InfRefId)
		throws PortalException, SystemException {
		return capitalInfPersistence.remove(InfRefId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CapitalInf deleteCapitalInf(CapitalInf capitalInf)
		throws SystemException {
		return capitalInfPersistence.remove(capitalInf);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(CapitalInf.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return capitalInfPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return capitalInfPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return capitalInfPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CapitalInf fetchCapitalInf(long InfRefId) throws SystemException {
		return capitalInfPersistence.fetchByPrimaryKey(InfRefId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CapitalInf getCapitalInf(long InfRefId)
		throws PortalException, SystemException {
		return capitalInfPersistence.findByPrimaryKey(InfRefId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return capitalInfPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CapitalInf> getCapitalInfs(int start, int end)
		throws SystemException {
		return capitalInfPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCapitalInfsCount() throws SystemException {
		return capitalInfPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CapitalInf updateCapitalInf(CapitalInf capitalInf)
		throws SystemException {
		return updateCapitalInf(capitalInf, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CapitalInf updateCapitalInf(CapitalInf capitalInf, boolean merge)
		throws SystemException {
		capitalInf.setNew(false);

		return capitalInfPersistence.update(capitalInf, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.sbi.StartUp.model.CapitalInf",
			capitalInfLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = capitalInfPersistence.getDataSource();
	...
	private CapitalInfLocalServiceClpInvoker _clpInvoker = new CapitalInfLocalServiceClpInvoker();
}